  ...
  <nav class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" aria-label="Navigation principale">
    <div class="flex items-center justify-between h-16">
      ...
      <div class="flex items-center gap-3">
        ...
        <a href="/inscription"
          class="hidden md:inline-flex items-center gap-1.5 bg-red-600 hover:bg-red-700 text-white text-sm font-semibold px-4 py-2 rounded-xl transition-colors shadow-sm">
    ...
    <div id="mobile-menu" class="hidden md:hidden pb-4" aria-hidden="true" role="menu">
      <div class="flex flex-col gap-1 pt-2 border-t border-gray-100">
        ...
        <!-- CTA mobile — rempli rouge, cohérent avec desktop -->
        <a href="/inscription" role="menuitem"
          class="px-3 py-2.5 text-sm font-semibold bg-red-600 hover:bg-red-700 text-white rounded-xl flex items-center gap-2 mt-1">
          <i class="fa-solid fa-store w-4 text-center" aria-hidden="true"></i>
          Créer ma boutique
        </a>
