    ...
    <div class="max-w-3xl mx-auto px-4 sm:px-6">
      ...
      <div class="grid sm:grid-cols-2 gap-4 mb-8">
        ...
        <a href="${waLink}" target="_blank" rel="noopener noreferrer"
          class="border border-green-200 bg-green-50 rounded-2xl p-5 flex flex-col items-center text-center hover:shadow-md transition-all group hover:border-green-400">
          <div class="w-14 h-14 bg-green-500 rounded-2xl flex items-center justify-center text-white mb-3 shadow-sm group-hover:scale-105 transition-transform">
        ...
        <form id="contact-form" class="space-y-5" onsubmit="submitContact(event)" novalidate>
          ...
          <div>
            <label for="contact-message" class="block text-sm font-semibold text-gray-700 mb-1.5">
              Votre message <span class="text-red-500" aria-hidden="true">*</span>
            </label>
